...
import { splitRouletteBets } from "@/entities/bet/index.js";
import { ROULETTE_COEFFICIENTS, } from "@/kernel/game/roulette/types.js";
import { prisma } from "@/shared/lib/db.js";
import { left, matchEither, right } from "@/shared/lib/either.js";
export async function payoutBet(roundId, result) {
    try {
...
export const getPayoutBetError = (payout) => matchEither(payout, {
    right: () => null,
    left: (e) => ({
...
//# sourceMappingURL=payout-bet.js.map